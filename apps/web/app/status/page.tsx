...
const ADRS = [
  ...
  ['ADR-016 — სამი სამუშაო სივრცე', 'მომხმარებელი, პარტნიორი და ადმინი სხვადასხვა ინტერფეისს ხედავენ. პარტნიორი თავისით ვერ რეგისტრირდება — კომპანიას სუპერ ადმინი ქმნის. პარტნიორის დამატებული პროდუქტი განხილვის რიგში ხვდება, რადგან თავსებადობის გარეშე მყიდველს მაინც ვერ ვაჩვენებთ.'],
] as const;
