...
1. ** არასწორი ფუნქციაა.** ინდექსირებული ტექსტი მთელი დოკუმენტია
   (სახელი + ყველა სინონიმი + კატეგორია), ამიტომ ორსიტყვიანი შეკითხვა მთელთან
   შედარებისას ყოველთვის ნულთან ახლოს ქულავდება. სწორია ,
   რომელიც შეკითხვას დოკუმენტის შიგნით საუკეთესო სიტყვათა მონაკვეთს ადარებს.

2. ** ქართულისთვის ტრიგრამებს საერთოდ არ აწარმოებს** Latin ctype-ზე —
    აბრუნებს . ეს არის ჩუმი ჩავარდნა: შეცდომა არ არის,
...
### ADR-011 — ბაზის ლოკალი არ უნდა იყოს 

**გადაწყვეტილება:** development-ის კლასტერი იქმნება UTF-8 ctype-ით
(), არა -ით.

**რატომ:**  ლოკალზე არა-ASCII სიმბოლოები ასოებად არ ითვლება. ეს ტექსტურ ძებნას
და -ს ჩუმად ამტვრევს — ისევ შეცდომის გარეშე. ეს პირველი კლასტერის შექმნისას
...
> ტრანსლიტერაცია fuzzy ძებნას იცავს, მაგრამ  და  მაინც ctype-ზეა
> დამოკიდებული.
---
